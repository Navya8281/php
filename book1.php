...
[6:55 PM, 12/30/2023] Nαʋყα νєηυ:       border: none;
    …
[7:35 PM, 12/30/2023] Nαʋყα νєηυ: <html>
<head>
<style>
    body {
      font-family:cursive;
...
<body>
<div id="regform">
<h2><center>DB Book Stall</center></h2>
<h3><center>Input Form</center></h3>
<form name="marksForm" action="check.php" method="post">
<label>Title:</label>
